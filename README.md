{
          ...
          onClick:function(e,tabID) {
            var table = Tabulator.findTable("#"+tabID+"-Result")[0];
            callApis([
              {
                arcturus: '\\caceis\\jirah\\persist_jirah_iso_9001',
                context: {
                    CREATED_DATE_FROM:variablesViews[tabID].param.CREATED_DATE_FROM,
                    CREATED_DATE_TO:variablesViews[tabID].param.CREATED_DATE_TO,
                    data: table.getData()
                  },
                parameter: {}
              }
            ])
            .then(function() { alert('Report Saved.'); })
            .catch(function(e) { console.log(e) });
          }
        },
        { 
          label:'Close Selected Tickets', onClick:function(e,tabID) { 
          console.log(tabID);
        ...
        { label:'Comment Tickets', onClick:function(e,tabID) { console.log(tabID);
